...
string check_options(string option) {
	if (option == "0") Close();
		...
		print_title(OPTIONS_POINTERS[1]); C2C1();
	}
	else if (option == "2") {
		print_title(OPTIONS_POINTERS[2]); C2C2();
	}
	else if (option == "3") {
		print_title(OPTIONS_POINTERS[3]); C2C3();
	}
	else if (option == "4") {
		print_title(OPTIONS_POINTERS[4]); C2C4();
	}
	else if (option == "5") {
		print_title(OPTIONS_POINTERS[5]); C2C5();
	}
	else if (option == "6") {
		print_title(OPTIONS_POINTERS[6]); C2C6();
	}
	else if (option == "7") {
		print_title(OPTIONS_POINTERS[7]); C2C7();
	}
	else if (option == "8") {
		print_title(OPTIONS_POINTERS[8]); C2C8();
	}
	else if (option == "9") {
		print_title(OPTIONS_POINTERS[9]); C2C9();
	}
