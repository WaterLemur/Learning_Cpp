...
int Create_Menu(const string title, const string menu_a[], 
	...
	while (!continue_) {
		...
		first_menu();
		print_title(title);
		Print_Menu(glue_menu(menu_a, menu_b, array_size), array_size, space);
		custom_input();
...
void Print_Menu(string menu_ab[], int size, string space) {
	print_lines(menu_ab, size, space);
}

void print_lines(const string menu_ab[], int SIZE, string space) {

	print_default_options(options_menu_a, options_menu_b, options_menu_size, space);
...
void print_default_options(const string menu_a[],  const string menu_b[], int menu_size, string menu_space) {
